  ...
  const aggregatedData: AggregatedDataItem[] = useMemo(() => {
    const filtered = expenses
      .filter((data: ExpenseByCategorySummary) => {
        // Convert date strings to comparable formats
        const dataDate = parseDate(data.date);

        // Check if the data falls within the selected date range and category
      ...
      .reduce((acc: AggregatedData, data: ExpenseByCategorySummary) => {
        ...
        // Aggregate the amount by category
    ...
    // Return aggregated data as an array to be used in the PieChart
